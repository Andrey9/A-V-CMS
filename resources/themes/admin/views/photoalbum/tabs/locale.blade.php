...
<div class="form-group @if ($errors->has($locale.'.meta_title')) has-error @endif">
    {!! Form::label($locale . '[meta_title]', trans('labels.meta_title'), ['class' => 'control-label col-xs-12 col-sm-3 col-md-2']) !!}
...
<div class="form-group @if ($errors->has($locale.'.meta_description')) has-error @endif">
    {!! Form::label($locale . '[meta_description]', trans('labels.meta_description'), ['class' => 'control-label col-xs-12 col-sm-3 col-md-2']) !!}
...
<div class="form-group @if ($errors->has($locale.'.meta_keywords')) has-error @endif">
    {!! Form::label($locale . '[meta_keywords]', trans('labels.meta_keywords'), ['class' => 'control-label col-xs-12 col-sm-3 col-md-2']) !!}
